...
$md = ims_claude_md_template( 'Test Realty', 'https://test.mystagingwebsite.com', $market_table );
...
ok( 'Generated: placeholder removed',           strpos( $md, '(Generated by iHF Migration Setup' ) === false );
