 ...
 * Description: Scans all WordPress pages, posts, and custom post types for buttons. Checks for missing hyperlinks and SEO title attributes, analyzes link trends, and allows bulk link assignment via a Button Map.
 * Version:     1.0.0
...
register_activation_hook( __FILE__, [ 'BLS_Database', 'install' ] );
