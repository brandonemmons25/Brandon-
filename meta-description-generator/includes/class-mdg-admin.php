    ...
    public static function enqueue_assets( string $hook ): void {
        ...
        wp_localize_script( 'mdg-admin', 'MDG', [
            ...
            'strings'    => [
                ...
                'chars_short'   => __( 'characters — Too short (aim for 140–156)', 'meta-description-generator' ),
                'chars_long'    => __( 'characters — Too long (aim for 140–156)', 'meta-description-generator' ),
