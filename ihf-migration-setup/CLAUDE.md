...
## Pre-Migration Scan (AiDX Scanner)

Run automatically on activation. Every IDX element found on this site is listed here — use it as your complete work inventory. Cross-reference menu URLs against the URL Redirect Map, page/post elements against the iHF Shortcode Reference and Client Market IDs table.

<!-- SCAN_RESULTS_START -->
(AiDX Scanner results generated on activation)
<!-- SCAN_RESULTS_END -->
